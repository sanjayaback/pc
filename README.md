# Purple Clone AI Showcase & Developer CRM

Welcome to the **Purple Clone AI Showcase & Developer CRM**. This is a premium frontend and backend full-stack application built to display AI Agents and capture inbound leads while offering a secured Developer CRM interface to manage those assets.
...
- **Developer CRM**: Password-protected area (`admin`) to view pipeline analytics, manage inbound leads, and mutate the product catalog in real-time.
